...
Blockly.Msg["ARABIC"] = "Arabic";  // untranslated
Blockly.Msg["BAD_CODE"] = "Program error: %1";  // untranslated
Blockly.Msg["BLUETOOTH_CONNECTION"] = "bluetooth";  // untranslated
Blockly.Msg["BLUETOOTH_SELECT_DEVICE"] = "select a device to connect";  // untranslated
...
Blockly.Msg["COLOUR_CATEGORY"] = "colour";  // untranslated
...
Blockly.Msg["JAVASCRIPT"] = "Javascript";  // untranslated
Blockly.Msg["LISTS_CATEGORY"] = "lists";  // untranslated
...
Blockly.Msg["LOGIC_CATEGORY"] = "logic";  // untranslated
...
Blockly.Msg["LOOPS_CATEGORY"] = "loops";  // untranslated
Blockly.Msg["LOOP_FOREVER"] = "repeat forever";  // untranslated
...
Blockly.Msg["MATH_CATEGORY"] = "math";  // untranslated
...
Blockly.Msg["PERSIAN"] = "Persian";  // untranslated
...
Blockly.Msg["PYTHON"] = "Python";  // untranslated
...
Blockly.Msg["ROOBIN_AMAZING_FACTS"] = "Did you know?";  // untranslated
Blockly.Msg["ROOBIN_ANGRY_BIRD"] = "angry bird";  // untranslated
Blockly.Msg["ROOBIN_ARROW_GAME"] = "arrows game %1";  // untranslated
Blockly.Msg["ROOBIN_ASK_WAIT"] = "ask %1 and wait for response";  // untranslated
Blockly.Msg["ROOBIN_ASK_WAIT_TEXT"] = "How are you?";  // untranslated
Blockly.Msg["ROOBIN_BATMAN"] = "batman";  // untranslated
Blockly.Msg["ROOBIN_BLINK"] = "blink";  // untranslated
Blockly.Msg["ROOBIN_CATEGORY"] = "roobin";  // untranslated
Blockly.Msg["ROOBIN_CHANGE_EYE"] = "change %1 eye to %2";  // untranslated
Blockly.Msg["ROOBIN_CHANGE_MOTOR_ROTATION_DEGREES"] = "change %1 motor rotation to %2 degrees";  // untranslated
Blockly.Msg["ROOBIN_CHANGE_MOUTH"] = "change mouth form to %1";  // untranslated
Blockly.Msg["ROOBIN_CHANGE_SPEAK_PITCH"] = "change speaking pitch by %1";  // untranslated
Blockly.Msg["ROOBIN_CHUCKLE"] = "Chckle";  // untranslated
Blockly.Msg["ROOBIN_CIRCULAR"] = "circular";  // untranslated
Blockly.Msg["ROOBIN_CLEAN_MATRICES"] = "turn off %1 for drawing";  // untranslated
Blockly.Msg["ROOBIN_DIAMOND"] = "diamond";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_EASY"] = "easy";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_HARD"] = "hard";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_IMPOSSIBLE"] = "impossible";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_LEVEL_ONE"] = "level 1";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_LEVEL_THREE"] = "level 3";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_LEVEL_TWO"] = "level 2";  // untranslated
Blockly.Msg["ROOBIN_DIFFICULTY_MEDIUM"] = "medium";  // untranslated
Blockly.Msg["ROOBIN_DOWNLOAD"] = "Download Code";  // untranslated
Blockly.Msg["ROOBIN_DRAW_ON_EYES"] = "turn %4 %1 eye in postitions %2 and %3";  // untranslated
Blockly.Msg["ROOBIN_DRAW_ON_MOUTH"] = "turn %3 mouth in postitions %1 and %2";  // untranslated
Blockly.Msg["ROOBIN_FIND_DAY"] = "what day was that day";  // untranslated
Blockly.Msg["ROOBIN_GAMES_EXPLANATION"] = "explanation for %1";  // untranslated
Blockly.Msg["ROOBIN_GAMES_LIST_ARROWS_GAME"] = "arrows game";  // untranslated
Blockly.Msg["ROOBIN_GAMES_LIST_NUMBERS_GAME"] = "numbers game";  // untranslated
Blockly.Msg["ROOBIN_GAMES_LIST_PATTERNS_GAME"] = "offline patterns game";  // untranslated
Blockly.Msg["ROOBIN_GAMES_LIST_RIDDLE"] = "riddle";  // untranslated
Blockly.Msg["ROOBIN_GAMES_LIST_SEARCH_IN_WIKI"] = "search in wikipedia";  // untranslated
Blockly.Msg["ROOBIN_HEAD"] = "head";  // untranslated
Blockly.Msg["ROOBIN_INPUT_BLOCKS_NAME"] = "download file name";  // untranslated
Blockly.Msg["ROOBIN_INTRODUCE"] = "introduce";  // untranslated
Blockly.Msg["ROOBIN_KITTY"] = "kitty";  // untranslated
Blockly.Msg["ROOBIN_LEFT"] = "left";  // untranslated
Blockly.Msg["ROOBIN_LEFT_EYE"] = "left eye";  // untranslated
Blockly.Msg["ROOBIN_LOOK_AROUND"] = "look around";  // untranslated
Blockly.Msg["ROOBIN_LOOK_NEUTRAL"] = "look straight ahead";  // untranslated
Blockly.Msg["ROOBIN_MINION"] = "minion";  // untranslated
Blockly.Msg["ROOBIN_MOUTH"] = "mouth";  // untranslated
Blockly.Msg["ROOBIN_MOVE_MOTOR"] = "move %1 motor to %2";  // untranslated
Blockly.Msg["ROOBIN_NECK"] = "neck";  // untranslated
Blockly.Msg["ROOBIN_NUMBERS_GAME"] = "numbers game %1";  // untranslated
Blockly.Msg["ROOBIN_OFF"] = "off";  // untranslated
Blockly.Msg["ROOBIN_ON"] = "on";  // untranslated
Blockly.Msg["ROOBIN_ORIGINAL"] = "original";  // untranslated
Blockly.Msg["ROOBIN_ORIGINAL_MOUTH"] = "roobin";  // untranslated
Blockly.Msg["ROOBIN_PATTERN_GAME"] = "offline patterns game %1";  // untranslated
Blockly.Msg["ROOBIN_PIXEL00"] = "pixel0";  // untranslated
Blockly.Msg["ROOBIN_PIXEL01"] = "pixel1";  // untranslated
Blockly.Msg["ROOBIN_PIXEL02"] = "pixel2";  // untranslated
Blockly.Msg["ROOBIN_PIXEL03"] = "pixel3";  // untranslated
Blockly.Msg["ROOBIN_PIXEL04"] = "pixel4";  // untranslated
Blockly.Msg["ROOBIN_PIXEL05"] = "pixel5";  // untranslated
Blockly.Msg["ROOBIN_PIXEL06"] = "pixel6";  // untranslated
Blockly.Msg["ROOBIN_PIXEL07"] = "pixel7";  // untranslated
Blockly.Msg["ROOBIN_PIXEL10"] = "pixel8";  // untranslated
Blockly.Msg["ROOBIN_PIXEL11"] = "pixel9";  // untranslated
Blockly.Msg["ROOBIN_PIXEL12"] = "pixel10";  // untranslated
Blockly.Msg["ROOBIN_PIXEL13"] = "pixel11";  // untranslated
Blockly.Msg["ROOBIN_PIXEL14"] = "pixel12";  // untranslated
Blockly.Msg["ROOBIN_PIXEL15"] = "pixel13";  // untranslated
Blockly.Msg["ROOBIN_PIXEL16"] = "pixel14";  // untranslated
Blockly.Msg["ROOBIN_PIXEL17"] = "pixel15";  // untranslated
Blockly.Msg["ROOBIN_PIXEL20"] = "pixel16";  // untranslated
Blockly.Msg["ROOBIN_PIXEL21"] = "pixel17";  // untranslated
Blockly.Msg["ROOBIN_PIXEL22"] = "pixel18";  // untranslated
Blockly.Msg["ROOBIN_PIXEL23"] = "pixel19";  // untranslated
Blockly.Msg["ROOBIN_PIXEL24"] = "pixel20";  // untranslated
Blockly.Msg["ROOBIN_PIXEL25"] = "pixel21";  // untranslated
Blockly.Msg["ROOBIN_PIXEL26"] = "pixel22";  // untranslated
Blockly.Msg["ROOBIN_PIXEL27"] = "pixel23";  // untranslated
Blockly.Msg["ROOBIN_PIXEL30"] = "pixel24";  // untranslated
Blockly.Msg["ROOBIN_PIXEL31"] = "pixel25";  // untranslated
Blockly.Msg["ROOBIN_PIXEL32"] = "pixel26";  // untranslated
Blockly.Msg["ROOBIN_PIXEL33"] = "pixel27";  // untranslated
Blockly.Msg["ROOBIN_PIXEL34"] = "pixel28";  // untranslated
Blockly.Msg["ROOBIN_PIXEL35"] = "pixel29";  // untranslated
Blockly.Msg["ROOBIN_PIXEL36"] = "pixel30";  // untranslated
Blockly.Msg["ROOBIN_PIXEL37"] = "pixel31";  // untranslated
Blockly.Msg["ROOBIN_PIXEL40"] = "pixel32";  // untranslated
Blockly.Msg["ROOBIN_PIXEL41"] = "pixel33";  // untranslated
Blockly.Msg["ROOBIN_PIXEL42"] = "pixel34";  // untranslated
Blockly.Msg["ROOBIN_PIXEL43"] = "pixel35";  // untranslated
Blockly.Msg["ROOBIN_PIXEL44"] = "pixel36";  // untranslated
Blockly.Msg["ROOBIN_PIXEL45"] = "pixel37";  // untranslated
Blockly.Msg["ROOBIN_PIXEL46"] = "pixel38";  // untranslated
Blockly.Msg["ROOBIN_PIXEL47"] = "pixel39";  // untranslated
Blockly.Msg["ROOBIN_PIXEL50"] = "pixel40";  // untranslated
Blockly.Msg["ROOBIN_PIXEL51"] = "pixel41";  // untranslated
Blockly.Msg["ROOBIN_PIXEL52"] = "pixel42";  // untranslated
Blockly.Msg["ROOBIN_PIXEL53"] = "pixel43";  // untranslated
Blockly.Msg["ROOBIN_PIXEL54"] = "pixel44";  // untranslated
Blockly.Msg["ROOBIN_PIXEL55"] = "pixel45";  // untranslated
Blockly.Msg["ROOBIN_PIXEL56"] = "pixel46";  // untranslated
Blockly.Msg["ROOBIN_PIXEL57"] = "pixel47";  // untranslated
Blockly.Msg["ROOBIN_PIXEL60"] = "pixel48";  // untranslated
Blockly.Msg["ROOBIN_PIXEL61"] = "pixel49";  // untranslated
Blockly.Msg["ROOBIN_PIXEL62"] = "pixel50";  // untranslated
Blockly.Msg["ROOBIN_PIXEL63"] = "pixel51";  // untranslated
Blockly.Msg["ROOBIN_PIXEL64"] = "pixel52";  // untranslated
Blockly.Msg["ROOBIN_PIXEL65"] = "pixel53";  // untranslated
Blockly.Msg["ROOBIN_PIXEL66"] = "pixel54";  // untranslated
Blockly.Msg["ROOBIN_PIXEL67"] = "pixel55";  // untranslated
Blockly.Msg["ROOBIN_PIXEL70"] = "pixel56";  // untranslated
Blockly.Msg["ROOBIN_PIXEL71"] = "pixel57";  // untranslated
Blockly.Msg["ROOBIN_PIXEL72"] = "pixel58";  // untranslated
Blockly.Msg["ROOBIN_PIXEL73"] = "pixel59";  // untranslated
Blockly.Msg["ROOBIN_PIXEL74"] = "pixel60";  // untranslated
Blockly.Msg["ROOBIN_PIXEL75"] = "pixel61";  // untranslated
Blockly.Msg["ROOBIN_PIXEL76"] = "pixel62";  // untranslated
Blockly.Msg["ROOBIN_PIXEL77"] = "pixel63";  // untranslated
Blockly.Msg["ROOBIN_PROJECTS_CATEGORY"] = "projects";  // untranslated
Blockly.Msg["ROOBIN_PROJECTS_EMPTY"] = "no projects found";  // untranslated
Blockly.Msg["ROOBIN_PROJECTS_LOADING"] = "loading projects";  // untranslated
Blockly.Msg["ROOBIN_PUCKER_MOUTH"] = "pucker";  // untranslated
Blockly.Msg["ROOBIN_RANDOM_GEN"] = "make a random number between %1 and %2";  // untranslated
Blockly.Msg["ROOBIN_RECOVERY"] = "Restart Roobin";  // untranslated
Blockly.Msg["ROOBIN_RIDDLE_GAME"] = "riddle";  // untranslated
Blockly.Msg["ROOBIN_RIGHT"] = "right";  // untranslated
Blockly.Msg["ROOBIN_RIGHT_EYE"] = "right eye";  // untranslated
Blockly.Msg["ROOBIN_ROTATE_MOTOR"] = "rotate %1 's motor by %2";  // untranslated
Blockly.Msg["ROOBIN_ROTATE_MOTOR_BY_DEGREES"] = "rotate %1 motor by %2 degrees";  // untranslated
Blockly.Msg["ROOBIN_SAY_HELLO"] = "Say hello";  // untranslated
Blockly.Msg["ROOBIN_SEARCH_IN_WIKI"] = "search in wikipedia";  // untranslated
Blockly.Msg["ROOBIN_SEARCH_WORD_IN_WIKI"] = "search %1 in wikipedia";  // untranslated
Blockly.Msg["ROOBIN_SET_LANG"] = "change language to %1";  // untranslated
Blockly.Msg["ROOBIN_SET_LANG_EN"] = "english";  // untranslated
Blockly.Msg["ROOBIN_SET_LANG_FA"] = "persian";  // untranslated
Blockly.Msg["ROOBIN_SET_SPEAK_PITCH"] = "speaking pitch = %1";  // untranslated
Blockly.Msg["ROOBIN_SET_SPEAK_SPEED"] = "speaking speed = %1";  // untranslated
Blockly.Msg["ROOBIN_SET_STT_VAR"] = "convert speech to text";  // untranslated
Blockly.Msg["ROOBIN_SPONGE_BOB"] = "sponge bob";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_ANIMAL_FARM_ONE"] = "animal farm 1";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_ANIMAL_FARM_THREE"] = "animal farm 3";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_ANIMAL_FARM_TWO"] = "animal farm 2";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_BOY_IN_DRUM"] = "a boy in a drum";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_CINDERELLA"] = "cinderella";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_EMPERORS_CLOTHES"] = "the emperor's new clothes";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_FINGERBOY"] = "fingerboy";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_GULLIVER"] = "gulliver";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_JACK_AND_BEANSTALK"] = "Jack and the beanstalk";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_LITTLE_PRINCE_ONE"] = "the little prince 1";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_LITTLE_PRINCE_TWO"] = "the little prince 2";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_MY_GLASSES"] = "my glasses";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_NOSE"] = "nose";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_ONE_BELOW"] = "one below the other";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_PUSS_IN_BOOTS"] = "puss in boots";  // untranslated
Blockly.Msg["ROOBIN_STORY_LIST_SNOWMAN"] = "snowman";  // untranslated
Blockly.Msg["ROOBIN_STORY_TELLING"] = "choose story %1";  // untranslated
Blockly.Msg["ROOBIN_STT"] = "convert speech to text";  // untranslated
Blockly.Msg["ROOBIN_SULLIVAN"] = "sullivan";  // untranslated
Blockly.Msg["ROOBIN_TODAY_DATE"] = "today's date";  // untranslated
Blockly.Msg["ROOBIN_TRIANGULAR"] = "triangular";  // untranslated
Blockly.Msg["ROOBIN_TTS"] = "Say %1";  // untranslated
Blockly.Msg["ROOBIN_TTS_TEXT"] = "Hello";  // untranslated
Blockly.Msg["ROOBIN_UPLOAD"] = "Upload Code";  // untranslated
Blockly.Msg["ROOBIN_WAIT"] = "wait %1 seconds";  // untranslated
Blockly.Msg["ROOBIN_WEATHER"] = "predict weather for %1";  // untranslated
Blockly.Msg["ROOBIN_WEATHER_TEXT"] = "tehran";  // untranslated
Blockly.Msg["ROOBIN_WHEN_KEY_PRESSED"] = "when %1 key pressed";  // untranslated
Blockly.Msg["ROOBIN_WIKI_SEARCH"] = "Iran";  // untranslated
Blockly.Msg["ROOBIN_YOU_SHOULD_BUY_THESE_BLOCKS"] = "You'd better have Roobin and its software to use these blocks!!";  // untranslated
Blockly.Msg["RUN"] = "run";  // untranslated
Blockly.Msg["SELECT_LANGUAGE"] = "select language";  // untranslated
Blockly.Msg["SERVER_INDICATOR_ONLINE"] = "online";  // untranslated
Blockly.Msg["SERVER_INDICATOR_PENDING"] = "pending";  // untranslated
Blockly.Msg["SHOW_CODE"] = "show code";  // untranslated
...
Blockly.Msg["TEXT_CATEGORY"] = "text";  // untranslated
...
Blockly.Msg["TIMEOUT"] = "Maximum execution iterations exceeded.";  // untranslated
Blockly.Msg["TODAY"] = "Šodiena";
Blockly.Msg["UNDO"] = "Atsaukt";
Blockly.Msg["UNNAMED_KEY"] = "nenosaukts";
Blockly.Msg["VARIABLES_CATEGORY"] = "variables";  // untranslated
